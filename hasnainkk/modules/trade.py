...
from hasnainkk import user_collection, app as shivuu

pending_trades = {}


@shivuu.on_message(filters.command("trade"), group=9171719196)
...
@shivuu.on_message(filters.command("gift"), group=9998881)
