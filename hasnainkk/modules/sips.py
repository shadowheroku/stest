# hasnainkk/commands/search_characters.py
from hasnainkk import app, collection, rarity_map2 as rarity_map
...
@app.on_message(filters.command("sips"), group=973826191)
