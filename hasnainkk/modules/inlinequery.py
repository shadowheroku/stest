...
from hasnainkk import application  # Assuming 'application' is the main bot object
from hasnainkk.unit.zyro_inline import *
...
HELP_NAME = "Iɴʟɪɴᴇ"
HELP = """Use inline queries to search for characters or view collections.
